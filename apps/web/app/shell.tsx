...
const LINKS = [
  ...
  { href: "/devis", label: "Devis", icon: "employes" },
  { href: "/factures", label: "Factures électroniques", icon: "validation" },
  { href: "/prospects", label: "Prospection", icon: "employes" },
  { href: "/marge", label: "Marge", icon: "cockpit" },
  { href: "/rapports", label: "Rapport mensuel", icon: "cockpit" },
  { href: "/echeancier", label: "Échéancier fiscal", icon: "cockpit" },
  { href: "/immobilisations", label: "Immobilisations", icon: "stocks" },
  { href: "/rh", label: "Équipe & plannings", icon: "employes" },
  { href: "/reglementaire", label: "Veille réglementaire", icon: "validation" },
  { href: "/avis", label: "Avis clients", icon: "employes" },
  { href: "/rgpd", label: "Assistant RGPD", icon: "validation" },
  { href: "/connecteurs", label: "Connecteurs", icon: "connecteurs" },
  { href: "/validation", label: "File de validation", icon: "validation" },
  { href: "/contrats", label: "Contrats", icon: "validation" },
  { href: "/reglages/metier", label: "Votre métier", icon: "employes" },
...
const TITLES: Record<string, string> = {
  ...
  "/classeur": "Classeur",
  "/stocks": "Stocks",
  "/devis": "Devis depuis un e-mail",
  "/factures": "Factures électroniques",
  "/prospects": "Prospection & relances",
  "/marge": "Marge & charges",
  "/rapports": "Rapport mensuel & anomalies",
  "/echeancier": "Échéancier fiscal & social",
