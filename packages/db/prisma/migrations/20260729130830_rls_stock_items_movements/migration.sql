-- ============================================================================
-- Row-Level Security sur `stock_items` et `stock_movements` (ticket 3.2 —
-- suivi des stocks + alertes. `stock_movements` est le journal APPEND-ONLY
-- des entrées/sorties de stock).
--
