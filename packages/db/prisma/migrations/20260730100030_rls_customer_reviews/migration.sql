-- ============================================================================
-- Row-Level Security sur `customer_reviews` (ticket 3.8 — avis clients /
-- e-réputation : notes, texte, réponse validée HITL).
--
...
CREATE POLICY tenant_isolation ON "customer_reviews"
  FOR ALL
